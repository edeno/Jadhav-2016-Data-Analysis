...
procInd1_Ia = cell(num_tetrodes, num_discrete_states);
...
for tetrode_ind = 1:num_tetrodes,
    for state_number = 1:num_discrete_states,
        [procInd1_Ia{tetrode_ind, state_number}, procInd1_I{tetrode_ind, state_number}, ...
            Xnum_I{tetrode_ind, state_number}, Lint_I{tetrode_ind, state_number}] = encode_per_tetrode( ...
