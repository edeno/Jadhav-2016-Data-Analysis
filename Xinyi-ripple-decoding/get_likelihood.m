function [likelihood] = get_likelihood(mark_spike_times, position_time_milliseconds, ...
...
spike_inds = find(mark_spike_times == position_time_milliseconds(ripple_time(time_step_ind)));
