...
gaussian_kernel_position_estimator = sum(normpdf(linear_distance_bins(num_spikes_axis, :)', ...
     linear_position_at_spike, linear_distance_bin_size), 2);

estimated_rate = gaussian_kernel_position_estimator ./ position_occupancy ./ dt; %integral
