function likelihood = decode_per_state(state_number, stateV_length, is_spike_at_time_t, tet_ind, tet_sum, marks, procInd1_I, Xnum_I, occ_I_Lambda, Lint_I, dt, smker)
